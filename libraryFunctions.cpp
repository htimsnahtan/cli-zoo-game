...
// GetRandIntInRange functor constructor
GetRandIntInRange::GetRandIntInRange()
{
    srand(time(NULL));
}

// GetRandIntInRange functor () overload
int GetRandIntInRange::operator()(int lowerBound, int upperBound)
{
